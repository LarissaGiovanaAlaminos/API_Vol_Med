...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver código htpp 400 quando informacoes estao invalidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deveria devolver código htpp 200 quando informacoes estao validas")
    @WithMockUser
